...
// FleetUnavailability), "booked" (existing booking), or "buffer"
// (cleaning/inspection window the fleet's BookingRule.padding_time
// reserves after every dropoff).
export interface UnavailableRange {
  start: string;
  end: string;
  reason: 'blocked' | 'booked' | 'buffer';
}
